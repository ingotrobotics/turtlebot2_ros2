...
# Kobuki udev rules
#lsuswget https://raw.githubusercontent.com/kobuki-base/kobuki_ftdi/devel/60-kobuki.rules
...
# Upgrade ecl_lite (https://github.com/stonier/ecl_lite/pull/38)
# edit kobuki_standalone.repos line for ecl_lite to version 1.2.x
...
#RUN colcon build --merge-install --cmake-args -DBUILD_TESTING=OFF -DCMAKE_BUILD_TYPE=RelWithDebInfo

# update the source workspacevcs pull /home/robot/src && deactivate
